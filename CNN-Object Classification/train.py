# โปรเจกต์คัดแยกวัตถุ 2 ชนิด (ขวดน้ำ vs แก้ว) ด้วย CNN
...
NUM_CLASSES = 2        # จำนวนคลาส (ขวดน้ำ, แก้ว)
...
def create_model():
    ...
    model = Sequential([
        ...
        # Output Layer (2 คลาส: ขวดน้ำ, แก้ว)
...
def main():
    ...
    if not os.path.exists(DATA_DIR):
        ...
        print("กรุณาสร้างโฟลเดอร์ 'dataset/bottle' และ 'dataset/glass' แล้วใส่รูปภาพ")
        return
    ...
    if len(subdirs) < 2:
        ...
        print("กรุณาสร้างโฟลเดอร์ 'bottle' และ 'glass' ใน dataset/")
        return
